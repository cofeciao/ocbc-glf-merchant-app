        ...
        use: [
          {
            loader: 'file-loader',
            options: {
              publicPath: process.argv[2] === '--env.file=staging' ? '' : process.argv[2] === '--env.file=prod' ? '/personal-banking/loans/mortgage-form-repricing/public/images' : process.argv[2] === '--env.file=bau' ? '/personal-banking/loans/mortgage-form-repricing-bau/public/images' : '/personal-banking/loans/mortgage-form-repricing-uat/public/images',

...
var InputFile = function InputFile(props) {
  ...
  var totalSizeUpload = _.sumBy(signatureFiles, function (item) {
  ...
  var handleFileUpload = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(fileList) {
      ...
      return _regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              errorFile = [];
              arrListFile = multiple ? _toConsumableArray(signatureFiles) : [];
              Object.values(fileList).map(function (item, index) {
                ...
                if (sizeFile > maxSizeFile) {
                  ...
                  setUploadFiles(function (uploadFiles) {
                    return _objectSpread(_objectSpread({}, uploadFiles), {}, _defineProperty({}, "".concat(item.name), true));
                  });
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          ...
                          case 11:
                            ...
                            if (renaming) {
                              setSignatureFiles(_toConsumableArray(arrListFile.map(function (item, index) {
                                return _objectSpread(_objectSpread({}, item), {}, {
                                  Name: "".concat(renaming, "_").concat(index + 1, ".").concat(item.DocType)
                                });
                              })));
                            } else {
                              setSignatureFiles(_toConsumableArray(arrListFile));
                            }
                  ...
                  setTimeout(function () {
                    setUploadFiles(function (uploadFiles) {
                      return _objectSpread(_objectSpread({}, uploadFiles), {}, _defineProperty({}, "".concat(item.name), false));
                    });
  ...
  var deleteFile = function deleteFile(indexFile) {
    var listFileDraf = _toConsumableArray(signatureFiles);
  ...
  var uploadFileContent = function uploadFileContent() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      className: clsx(classes.uploadFileContent)
    ...
    }, "Drag and drop to upload a file, or"), ' ', /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("span", {
      className: clsx(classes.linkDot, classes.hiddenM)
    }, "browse"), /*#__PURE__*/React.createElement("span", {
      className: clsx(classes.linkDot, classes.showM)
    }, "Browse to upload a file")))), /*#__PURE__*/React.createElement("input", {
      ref: refInput,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: clsx(classes.content, "".concat(textLinkDownload ? classes.fullWith : ''))
  }, signatureFiles.length > 0 ? /*#__PURE__*/React.createElement(React.Fragment, null, labelAfter) : /*#__PURE__*/React.createElement(React.Fragment, null, labelBefore), textLinkDownload && /*#__PURE__*/React.createElement("a", {
    href: fileDownload,
    download: true,
    className: classes.linkDownload
  }, ' ', textLinkDownload)), contentBody.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "mt-20"
  }, contentBody)), /*#__PURE__*/React.createElement(Grid, {
    item: true,
    lg: 5,
    md: 5,
    sm: 5,
    ...
    }, uploadFiles["".concat(item.Name)] && uploadFiles["".concat(item.Name)] ? /*#__PURE__*/React.createElement("img", {
      src: Uploading,
      className: clsx(classes.checkIcon, 'spin'),
      alt: "upload"
    }) : /*#__PURE__*/React.createElement("img", {
      src: CheckIcon,
    ...
    }, "".concat(item.Name, " (").concat(item.Size, " MB)")), /*#__PURE__*/React.createElement("span", {
      className: clsx(classes.cursorPointer, classes.deleteIcon),
  ...
  })))), hiddenInput && multiple && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "".concat(clsx(classes.marginBoxUpload, classes.uploadFile, focusInput && classes.onHover)),
  ...
  }, uploadFileContent()), errorMessage && /*#__PURE__*/React.createElement("div", {
    className: "".concat(classes.message, " ").concat(classes.marginErrorMessage)
  }, errorMessage)), !hiddenInput && multiple && maxFiles && signatureFiles.length < maxFiles && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "".concat(clsx(classes.marginBoxUpload, classes.uploadFile, focusInput && classes.onHover, signatureFiles.length > 0 && classes.onHover)),
    onMouseEnter: function onMouseEnter() {
      return setFocusInput(true);
    },
    onMouseLeave: function onMouseLeave() {
    ...
    className: "".concat(classes.message, " ").concat(classes.marginErrorMessage)
  }, errorMessage)), signatureFiles.length <= maxFiles && labelFooter && errorMessage === '' && /*#__PURE__*/React.createElement("div", {
...
InputFile.propTypes = {
  ...
  marginErrorMessage: PropTypes.string,
  marginBoxUpload: PropTypes.string,
  labelAfter: PropTypes.string,
  labelFooter: PropTypes.string,
  hiddenInput: PropTypes.bool,
  getValue: PropTypes.func,
  maxFileName: PropTypes.number,
  maxFiles: PropTypes.number,
  required: PropTypes.bool,
  defaultValue: PropTypes.array,
  title: PropTypes.string,
  contentBody: PropTypes.any,
  errorConnection: PropTypes.bool,
  hasLoading: PropTypes.bool,
  messageError: PropTypes.string,
  textLinkDownload: PropTypes.string,
  fileDownload: PropTypes.string,
  id: PropTypes.string,

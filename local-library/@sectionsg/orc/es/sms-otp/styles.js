...
var useStyles = makeStyles(function (theme) {
  ...
  return {
    ...
    inputNumber: {
      ...
      }, _defineProperty(_input, "border", "0 !important"), _defineProperty(_input, "height", 'auto !important'), _defineProperty(_input, "paddingLeft", 0), _defineProperty(_input, "borderBottom", "1px solid ".concat(theme.palette.$greyishBrown, " !important")), _defineProperty(_input, "fontFamily", theme.typography.fontFamily), _defineProperty(_input, '&::placeholder', {

...
module.exports = {
  theme: {},
  activeRule: 'personal-banking/loans/mortgage-form-repricing-uat/',
  APIServer: 'https://uwosswaos0a.ocbcgroup.ocbc.com',
  env: 'uat',
  myinfo: {
    api: 'https://test.api.myinfo.gov.sg/com/v3/authorise',
    redirectUri: 'https://internet-uat.ocbc.com/personal-banking/loans/mortgage-form-repricing-uat',
